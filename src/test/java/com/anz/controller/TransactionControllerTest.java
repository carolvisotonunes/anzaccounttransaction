...
public class TransactionControllerTest {
    ...
    public void shouldReturnListWhenTransactionWithAccountAtURL() throws SQLException {
        ...
        Transaction transaction1 = new Transaction(5478963254L, 5869712549L, "Bill", LocalDate.of(2019, 7, 1), "AUD", 1548.24, 0.0, "DEBIT", "desc1");
        Transaction transaction2 = new Transaction(254789652L, 5869712549L, "Bill",  LocalDate.of(2019, 7, 1), "AUD", 865.47, 0.0, "DEBIT", "desc2");
